...
//     estimateSize: () => 440, // height of each card in px
//   })
...
//   //
//   //
//   const observerFlagRef = useRef<HTMLDivElement | null>(null)
//   useEffect(() => {
//     console.log(observerFlagRef.current)
//     const observer = new IntersectionObserver((entries) => {
//       if (entries[0].isIntersecting) {
//         // You can trigger loading more data here
//         console.log('observer-flag is visible!')
//         if (!data) {
//           console.log('No data')
...
//     if (observerFlagRef.current) {
//       observer.observe(observerFlagRef.current)
//     }

//     return () => {
//       if (observerFlagRef.current) {
//         observer.unobserve(observerFlagRef.current)
//       }
//     }
//   }, [data])
...
//         })}
//         <div
//           className="absolute bottom-0 w-full h-96 bg-black"
//           ref={observerFlagRef}
//         ></div>
//       </div>
//     </div>

...
// type MediaSignInType = 'google' | 'github'
// type MediaSignInProps = {
//   type: MediaSignInType
// }
...
type MediaSignInType = keyof typeof buttonData

export default function AuthFormLoginButton({
  mediaSingIn,
}: {
  mediaSingIn: MediaSignInType
}) {
  const icon = buttonData[mediaSingIn]
